...
class Command(BaseCommand):
    help = "Upsert all FrameConfig records from the canonical FRAMES list."
    ...
    def handle(self, *args, **options):
        ...
        #
        # m2s (mobile 2-square) canvas=3000x3000
        MS2_SLOT = [
            {"index": 0, "x": 120,  "y": 920, "w": 822, "h": 1510, "radius": 150},
            {"index": 1, "x": 1088, "y": 940, "w": 822, "h": 1495, "radius": 150},
            {"index": 2, "x": 2055, "y": 940, "w": 822, "h": 1495, "radius": 150},
        ]
        ...
        FRAMES = [
            ...
            },
            {
                ...
                "canvas_width": 3000, "canvas_height": 3000,
                "slots": MS2_SLOT,
                "static_overlay": "frames/shayan_m2s.png",
            },
        ]
        ...
        for i, data in enumerate(FRAMES):
            ...
            lookup = {
                "darshan_type": data.pop("darshan_type"),
                "frame_type":   data.pop("frame_type"),
            }
            _, created = FrameConfig.objects.update_or_create(
                **lookup,
                defaults=data,
            )
            label = f"{lookup['darshan_type']} / {lookup['frame_type']}"
            if created:
                created_count += 1
